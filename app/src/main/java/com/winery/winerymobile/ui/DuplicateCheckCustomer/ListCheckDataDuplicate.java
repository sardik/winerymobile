...
public class ListCheckDataDuplicate extends AppCompatActivity {
    ...
    @BindView(R.id.ll_parent_blank_data)
    LinearLayout llParentBlankData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_check_data_duplicate);

        ButterKnife.bind(this);

        mApiService = UtilsApi.getAPIService();
        initToolbar();
        getDataCheckDuplicate();
    }
...
//                                    Toast.makeText(ListCheckDataDuplicate.this, "Data", Toast.LENGTH_SHORT).show();


                                } else {
                                    nested.setVisibility(View.GONE);
                                    llParentBlankData.setVisibility(View.VISIBLE);
