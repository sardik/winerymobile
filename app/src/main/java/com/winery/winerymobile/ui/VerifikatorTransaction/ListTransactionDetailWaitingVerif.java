...
public class ListTransactionDetailWaitingVerif extends AppCompatActivity {
    ...
    @OnClick(R.id.btn_submit) void gotoSelectionBank(){
        ...
        stateTransactionSales.createStateBank(statusBri.getText().toString(), statusBni.getText().toString(),
                statusBca.getText().toString(), statusCimb.getText().toString(), statusMayapada.getText().toString(),
                statusDbs.getText().toString(), statusMnc.getText().toString(), statusUob.getText().toString(),
                statusMega.getText().toString(), statusPanin.getText().toString());

        Intent intent =  new Intent(this, FormSubmitSelectionBank.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_transaction_detail_waiting_verif);
