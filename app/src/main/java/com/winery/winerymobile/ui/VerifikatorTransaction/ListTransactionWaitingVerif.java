...
public class ListTransactionWaitingVerif extends AppCompatActivity {
    ...
    @OnClick(R.id.btn_search) void filterdata() {
        ...
        if(etStartDate.getText().toString().equals("") || etStartDate.getText().toString().equals(null)){
            ...
            if(daysBetween > 14){
                ...
                requestGetHistoryWaitingVerif(etStartDate.getText().toString(), etEndDate.getText().toString());
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_transaction_waiting_verif);
    ...
    private void requestGetHistoryWaitingVerif(String startDate, String endDate ){
        loading = ProgressDialog.show(ListTransactionWaitingVerif.this, null, "Harap Tunggu...", true, false);
        HashMap<String, String> user = sessionManagement.getUserDetails();
        String code = user.get(SessionManagement.KEY_SALES_CODE);

        mApiService.getListVerifyTransactionList(startDate, endDate,code)
...
//                                        JSONArray arr_jsonArticle = m_jsonData.getJSONArray("articles");
                                    ...
                                    if(m_jsonData.length() == 0){
                                        ...
                                        rvHistoryCc.setLayoutManager(new LinearLayoutManager(ListTransactionWaitingVerif.this, LinearLayoutManager.VERTICAL, false));
                                        lIstHistoriCCAdapter = new LIstHistoriCCAdapter(ListTransactionWaitingVerif.this, historyCcList, R.layout.adapter_history_list);
