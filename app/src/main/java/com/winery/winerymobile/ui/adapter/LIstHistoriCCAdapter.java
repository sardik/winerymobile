...
public class LIstHistoriCCAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public LIstHistoriCCAdapter(Context context, List<HistoryCc> items, int layout_id) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        vh = new LIstHistoriCCAdapter.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof LIstHistoriCCAdapter.OriginalViewHolder) {
            LIstHistoriCCAdapter.OriginalViewHolder view = (LIstHistoriCCAdapter.OriginalViewHolder) holder;
            ...
            view.lyt_parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(loginAs.equals("sales")){
                        ...
                        Intent intent = new Intent(ctx, ListTransactionDetailWaitingVerif.class);
                        intent.putExtra("param", obj.getId());
                        ctx.startActivity(intent);
                    }else if(loginAs.equals("jurutulis")){
                        Intent intent = new Intent(ctx, ListTransactionDetailPendingJurtul.class);
                        intent.putExtra("param", obj.getId());
                        ctx.startActivity(intent);
                    }
